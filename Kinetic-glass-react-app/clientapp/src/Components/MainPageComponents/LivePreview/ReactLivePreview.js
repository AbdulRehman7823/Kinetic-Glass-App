...
import { BlogImageCard, Button } from "kinetic-glass-ui";
...
function ReactLivePreview(prop) {
  ...
  return (
    <div className="items-center px-4 flex flex-col justify-left w-full">
      ...
      <br></br>
      <b className="w-full text-gray-700 font-medium">{props.description}</b>
      <br></br>
      ...
      <div className="w-full p-4 border-2 border-gray-200 rounded my-2">
        <JsxParser components={{Button,BlogImageCard}}
        jsx={props.code} />
      </div>
